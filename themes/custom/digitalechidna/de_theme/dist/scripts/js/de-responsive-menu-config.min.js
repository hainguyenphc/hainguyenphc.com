    ...
    attach: function attach(context) {
      $(context).find('body').once('mm-menu').each(function () {
        if (typeof Mmenu !== 'undefined') {
          ...
          $('.mm-tabstart').remove();
          $('.mm-tabend').remove(); // Mobile menu active trail items_block--card-grid.scss
      ...
      if (!$('body').hasClass('user-logged-in')) {
        ...
        $mobileAccountMenu.attr('id', 'block-user-menu-mobile').addClass('menu--account--mobile').removeClass('dropdown-menu').removeClass('dropdown-menu-right').prepend($mobileUserImage);
