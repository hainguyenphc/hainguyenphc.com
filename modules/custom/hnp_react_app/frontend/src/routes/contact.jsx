    ...
    <div id="contact">
      ...
      <div>
        ...
        <div>
          ...
          <Form
            method="post"
            // Points to the `/destroy` route aka
            // `/contacts/{ID}/destroy`
            action="destroy"
            onSubmit={(event) => {
              if (
...
// These params are passed to the loader with keys that match the dynamic segment. For example, our segment is named :contactId 
