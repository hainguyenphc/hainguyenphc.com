...
/**
 * Provides menu link definitions for all entity types.
 */
class EntityReportsMenuLinks extends DeriverBase implements ContainerDeriverInterface {
    ...
    foreach ($this->entityTypeManager->getDefinitions() as $entity_type_id => $entity_type) {
      if ($entity_type->entityClassImplements(FieldableEntityInterface::class)) {
        ...
        $this->derivatives["entity_reports.entity_structure.$entity_type_id"] = [
          'title' => Markup::create($entity_type->getLabel()),
          'route_name' => "entity_reports.entity_structure.$entity_type_id",
          'parent' => 'entity_reports.entity_types',
          'menu_name' => 'admin',
