...
class ExtractedText extends FileFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $extractorPluginId = $instance->config->get('extraction_method');
    $configuration = $instance->config->get($extractorPluginId . '_configuration');
    $instance->extractionMethod = $instance->textExtractorPluginManager->createInstance($extractorPluginId, $configuration);
    $instance->extractor = $instance->processorPluginManager->createInstance('file_attachments');
    return $instance;
  }
